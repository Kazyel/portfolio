...
const Navbar = ({
  ...
  return (
    <nav
      id="navbar"
      className="fixed z-10 mt-8 flex h-fit min-w-[676px] items-center justify-between  px-6 py-4 text-off-w"
    >
      <a
        astro-data-reload
        href="/"
        className="border-l-2 px-2 text-2xl font-bold"
      >
        Kazyel
      </a>
      <ul className="flex items-center gap-4">
        {links.map(({ isActive, href, title }) => (
